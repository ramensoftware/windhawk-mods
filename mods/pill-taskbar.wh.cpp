// ==WindhawkMod==
// @id              pill-taskbar-for-windows-11
// @name            Pill Taskbar for Windows 11
// @description     Custom theme for the taskbar. Credits to @m417z
// @version         1.0
// @author          EMs1
// @github          https://github.com/EMs1-Dev
...
const Theme g_themePillsTaskbar = {{ 
...
void ProcessAllStylesFromSettings() {
    ...
    if (wcscmp(themeName, L"Taskbar") == 0) {
        theme = &g_themePillsTaskbar;}
