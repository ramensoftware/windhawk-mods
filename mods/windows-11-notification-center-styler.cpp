...
// @version         1.0.0
// @author          thx1200
// @github          https://github.com/thx1200
...
An advanced mod to override style attributes of the notification center and calendar.

**Note**: This mod requires Windhawk v1.4 or later.

This is adapted from the **Windows 11 Taskbar Styler** mod.  I really did very little.  All credit goes to m417z.
...
The notitfication center's XAML resources can help find out which elements and resource
