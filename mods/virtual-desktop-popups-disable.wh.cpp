...
BOOL Wh_ModInit()
{
    ...
    static const WindhawkUtils::SYMBOL_HOOK c_rgTwinUIHooks[] =
    {
        {
            {
                L"public: virtual long " SSTDCALL " CAudioFlyoutController::VirtualDesktopSwitched(struct IVirtualDesktop *)",
            },
        ...
        {
            {
                L"public: virtual long " SSTDCALL " CAudioFlyoutController::VirtualDesktopSwitched(struct IVirtualDesktop *,enum VirtualDesktopSwitchType)",
            },
    ...
    HMODULE hTwinUIPCShell = LoadLibraryExW(L"twinui.dll", nullptr, LOAD_LIBRARY_SEARCH_SYSTEM32);
    if (!WindhawkUtils::HookSymbols(hTwinUIPCShell, c_rgTwinUIHooks, ARRAYSIZE(c_rgTwinUIHooks))
