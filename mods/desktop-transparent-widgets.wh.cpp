// ==WindhawkMod==
// @id              desktop-transparent-widgets
// @name            JonaOS Draggable Transparent Widgets
...
![Widgets preview](https://imgur.com/gallery/widgets-pggFD5f#mGAWwJP.png)
*/
// ==/WindhawkModReadme==
...
Widget g_widgets[WidgetCount] = {
    ...
    {WidgetClock,           RectF(15, 215, 165, 170), false},
    {WidgetMusic,           RectF(215, 215, 165, 170), false},
    {WidgetVolume,          RectF(30, 415, 350, 30), false},
    {WidgetBattery,         RectF(30, 475, 350, 30), false},
    {WidgetSearch,          RectF(15, 535, 160, 30), false},
    {WidgetPersonalization, RectF(215, 535, 160, 30), false},
