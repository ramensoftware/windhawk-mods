...
XP Top Ultimate Customizable Dock Bar — Удобная верхняя панель в стиле классических док-панелей для Windows
Оригинальная и гибко настраиваемая верхняя панель задач для Windows (explorer.exe), вдохновленная классическими интерфейсами и современными док-панелями. Создана для быстрого доступа к любимым программам, папкам и дискам в один клик.
🔥 Основные возможности:
Полная кастомизация внешнего вида: Настройка высоты панели, размеров иконок, шрифтов, а также ширины ячеек ярлыков под себя.
Гибкая настройка цветов: Отдельный выбор цвета фона панели, цвета подписей к ярлыкам и подсветки при наведении (Hover).
Визуальные эффекты: Несколько вариантов подсветки активных элементов (мягкое свечение, классическая рамка, нижняя линия, эффект размытия/блюра или отключение эффектов).
Позиционирование текста: Подписи к ярлыкам можно разместить снизу, сверху, слева, справа, по центру или полностью скрыть для минималистичного вида.
Drag-and-Drop и закрепление: Удобное перетаскивание и сортировка ярлыков прямо на панели, добавление новых файлов через диалоговое окно или простое перетаскивание (Drag & Drop), а также блокировка перемещения от случайных сдвигов.
Режимы работы: Возможность включить автоскрытие (появление панели при наведении мыши на самый верх экрана) или полностью закрепить её на рабочем столе.
⚠️ Примечание для геймеров:
Чтобы панель случайно не выпадала во время динамичных игровых сессий и не перехватывала управление мышкой, в мод встроена умная защита. Если запущено приложение или игра в полноэкранном режиме, панель автоматически блокирует появление при наведении на верхний край экрана. Как только вы свернете игру или выйдете на рабочий стол (Alt + Tab), панель снова начнет работать в штатном режиме.
