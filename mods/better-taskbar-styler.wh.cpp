// ==WindhawkMod==
// @id              taskbar-styler-fanmade
// @name            Taskbar Styler (FANMADE)
// @description     A better Taskbar Styler. (NOT FINISHED)
// @version         1.0.2
// @author          Rainn (ORIGINAL CREATOR: m417z)
...
const Theme g_themeDockLike = {{
    ...
    ThemeTargetStyles{L"Taskbar.TaskbarFrame > Grid#RootGrid", {
        L"Background:=<WindhawkBlur BlurAmount=\"5\" TintColor=\"{ThemeResource SystemChromeAltHighColor}\" TintOpacity=\"0.05\" />",
        L"Padding=6,0,6,0",
        L"CornerRadius=12,12,12,12",
        L"BorderThickness=1.5", 
        L"BorderBrush:=<SolidColorBrush Color=\"#88FFFFFF\" />" }},
    ThemeTargetStyles{L"Taskbar.TaskbarFrame > Grid#RootGrid > Taskbar.TaskbarBackground > Grid > Rectangle#BackgroundFill", {
        L"Visibility=Collapsed"}},
    ThemeTargetStyles{L"Rectangle#BackgroundStroke", {
        L"Visibility=Collapsed"}},
