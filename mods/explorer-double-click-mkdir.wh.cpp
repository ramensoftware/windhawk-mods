// ==WindhawkMod==
// @id              explorer-double-click-mkdir
// @name            Explorer Double Click mkdir
// @description     Double click empty space to make a directory
// @version         1.0.0
// @author          Alfakynz
// @github          https://github.com/Alfakynz
...
//
// The code was taken from the mod "Explorer Double Click Up", which is licensed under GPL-3.0.
// By this mod:
...
// ==WindhawkModReadme==
/*
# Explorer Double Click mkdir

Double click empty space to make a directory
